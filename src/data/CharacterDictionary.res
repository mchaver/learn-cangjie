...
let characterDictionary: Belt.Map.String.t<characterInfo> = Belt.Map.String.fromArray([
  ...
  ("卍", makeChar("卍", "NX", Some(["弓", "難"]), ())),
  ("入", makeChar("入", "OH", Some(["人", "竹"]), ())),
  ("个", makeChar("个", "OL", Some(["人", "中"]), ())),
  ("仙", makeChar("仙", "OU", Some(["人", "山"]), ())),
  ...
  ("耳", makeChar("耳", "SJ", Some(["尸", "十"]), ())),
  ("共", makeChar("共", "TC", Some(["廿", "金"]), ())),
  ("卅", makeChar("卅", "TJ", Some(["廿", "一"]), ())),
  ("甘", makeChar("甘", "TM", Some(["廿", "一"]), ())),
  ...
  ("立", makeChar("立", "YT", Some(["卜", "廿"]), ())),
  ("齊", makeChar("齊", "YX", Some(["卜", "難"]), ())),
  ...
  ("身", makeChar("身", "HXH", Some(["竹", "難", "竹"]), ())),
  ("成", makeChar("成", "IHS", Some(["戈", "十"]), ())),
  ("慶", makeChar("慶", "IXE", Some(["戈", "難", "水"]), ())),
  ("廌", makeChar("廌", "IXF", Some(["戈", "難", "火"]), ())),
  ...
  ("表", makeChar("表", "QMV", Some(["手", "一", "女"]), ())),
  ("黽", makeChar("黽", "RXU", Some(["口", "難", "山"]), ())),
  ("局", makeChar("局", "SSR", Some(["尸", "尸", "口"]), ())),
  ("司", makeChar("司", "SMR", Some(["尸", "一", "口"]), ())),
  ("草", makeChar("草", "TAJ", Some(["廿", "日"]), ())),
  ("若", makeChar("若", "TKR", Some(["廿", "口"]), ())),
  ("朔", makeChar("朔", "TUB", Some(["廿", "山", "月"]), ())),
  ("兼", makeChar("兼", "TXC", Some(["廿", "難", "金"]), ())),
  ...
  ("淵", makeChar("淵", "ELXL", Some(["水", "中", "難", "中"]), ())),
  ("學", makeChar("學", "HBND", Some(["竹", "月", "弓", "木"]), ())),
  ("龜", makeChar("龜", "HBSS", Some(["竹", "月", "尸", "尸"]), ())),
  ("重", makeChar("重", "HJWG", Some(["竹", "十", "田", "土"]), ())),
  ("與", makeChar("與", "HXYC", Some(["竹", "難", "卜", "金"]), ())),
  ("興", makeChar("興", "HXBC", Some(["竹", "難", "月", "金"]), ())),
  ("盥", makeChar("盥", "HXBT", Some(["竹", "難", "月", "廿"]), ())),
  ("為", makeChar("為", "IKNF", Some(["戈", "大", "弓", "火"]), ())),
  ("爾", makeChar("爾", "MFBK", Some(["一", "火", "月", "大"]), ())),
  ("互", makeChar("互", "MVNM", Some(["一", "女", "弓", "一"]), ())),
  ...
  ("姊", makeChar("姊", "VLXH", Some(["女", "中", "難", "竹"]), ())),
  ...
  ("巡", makeChar("巡", "YVVV", Some(["卜", "女", "女", "女"]), ())),
